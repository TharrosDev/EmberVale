...
| HIGH | assets/models/creatures/enm_ash_dragon.glb | ground-offset | lowest rendered point is Z=-4.178 m in Blender | IMPROVE |
...
| HIGH | assets/models/creatures/enm_bone_knight.glb | collision-render-mismatch | Blender evaluated render height 1.09 m vs authored capsule height(s) [1.8] | IMPROVE |
| HIGH | assets/models/creatures/enm_bone_knight.glb | ground-offset | lowest rendered point is Z=-0.314 m in Blender | IMPROVE |
...
| HIGH | assets/models/creatures/enm_cinder_thrall.glb | collision-render-mismatch | Blender evaluated render height 0.94 m vs authored capsule height(s) [1.8] | IMPROVE |
...
| HIGH | assets/models/creatures/enm_clan_raider.glb | ground-offset | lowest rendered point is Z=-0.295 m in Blender | IMPROVE |
...
| HIGH | assets/models/creatures/enm_goblin.glb | collision-render-mismatch | Blender evaluated render height 0.48 m vs authored capsule height(s) [1.7] | IMPROVE |
| HIGH | assets/models/creatures/enm_goblin.glb | ground-offset | lowest rendered point is Z=0.602 m in Blender | IMPROVE |
...
| HIGH | assets/models/creatures/enm_grave_shade.glb | collision-render-mismatch | Blender evaluated render height 1.14 m vs authored capsule height(s) [1.7] | IMPROVE |
...
| HIGH | assets/models/creatures/enm_grave_shade.glb | ground-offset | lowest rendered point is Z=-0.180 m in Blender | IMPROVE |
...
| HIGH | assets/models/creatures/enm_hollow_husk.glb | collision-render-mismatch | Blender evaluated render height 1.06 m vs authored capsule height(s) [1.75] | IMPROVE |
| HIGH | assets/models/creatures/enm_hollow_husk.glb | ground-offset | lowest rendered point is Z=-0.305 m in Blender | IMPROVE |
...
| HIGH | assets/models/creatures/enm_stone_sentinel.glb | ground-offset | lowest rendered point is Z=-0.516 m in Blender | IMPROVE |
...
| HIGH | assets/models/creatures/enm_wild_dragon.glb | ground-offset | lowest rendered point is Z=-3.633 m in Blender | IMPROVE |
