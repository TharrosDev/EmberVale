...
- Production assets audited: **157** (`assets/models/**/*.glb|gltf`)
- Categories: animations 1, architecture 22, characters 15, creatures 33, equipment 4, props 81, weapons 1
- Findings: 161 (high 105, info 22, medium 34)
- Recommendations: IMPROVE 67, KEEP 83, REPLACE 7
...
- Committed diagnostic render files: **6**
