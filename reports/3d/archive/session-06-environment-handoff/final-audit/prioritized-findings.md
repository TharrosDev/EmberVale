...
| HIGH | assets/models/architecture/mod_shutters_thin_closed.gltf | ground-offset | lowest rendered point is Z=1.093 m in Blender | IMPROVE |
| HIGH | assets/models/architecture/mod_shutters_wide_open.gltf | ground-offset | lowest rendered point is Z=1.093 m in Blender | IMPROVE |
| HIGH | assets/models/architecture/mod_vine.gltf | ground-offset | lowest rendered point is Z=-2.121 m in Blender | IMPROVE |
...
| HIGH | assets/models/architecture/mod_roof_awning.gltf | ground-offset | lowest rendered point is Z=-0.342 m in Blender | IMPROVE |
| HIGH | assets/models/architecture/mod_roof_supports.gltf | ground-offset | lowest rendered point is Z=-0.118 m in Blender | IMPROVE |
...
| HIGH | assets/models/architecture/mod_balcony_corner.gltf | ground-offset | lowest rendered point is Z=-0.105 m in Blender | IMPROVE |
| HIGH | assets/models/architecture/mod_balcony_straight.gltf | ground-offset | lowest rendered point is Z=-0.105 m in Blender | IMPROVE |
| HIGH | assets/models/props/prp_glacier_face.glb | unresolved-provenance | no confident manifest/CREDITS provenance match | KEEP |
| HIGH | assets/models/props/prp_rock_medium.glb | ground-offset | lowest rendered point is Z=-0.271 m in Blender | IMPROVE |
...
| HIGH | assets/models/architecture/mod_roof_4x8.gltf | ground-offset | lowest rendered point is Z=-0.516 m in Blender | IMPROVE |
| HIGH | assets/models/architecture/mod_roof_6x6.gltf | ground-offset | lowest rendered point is Z=-0.782 m in Blender | IMPROVE |
| HIGH | assets/models/architecture/mod_roof_8x8.gltf | ground-offset | lowest rendered point is Z=-0.780 m in Blender | IMPROVE |
...
| HIGH | assets/models/props/prp_cliff_face.glb | unresolved-provenance | no confident manifest/CREDITS provenance match | KEEP |
| HIGH | assets/models/props/prp_cliff_face_tall.glb | unresolved-provenance | no confident manifest/CREDITS provenance match | KEEP |
...
| HIGH | assets/models/architecture/mod_roof_6x10.gltf | ground-offset | lowest rendered point is Z=-0.782 m in Blender | KEEP |
...
| MEDIUM | assets/models/architecture/mod_wall_stone.gltf | metallic-stone-risk | MI_Plaster uses metallic multiplier 1.00 with a metallic/roughness texture; inspect channel values | KEEP |
| MEDIUM | assets/models/architecture/mod_wall_stone_door.gltf | metallic-stone-risk | MI_Plaster uses metallic multiplier 1.00 with a metallic/roughness texture; inspect channel values | KEEP |
| MEDIUM | assets/models/architecture/mod_wall_stone_window.gltf | metallic-stone-risk | MI_Plaster uses metallic multiplier 1.00 with a metallic/roughness texture; inspect channel values | KEEP |
| MEDIUM | assets/models/architecture/mod_wall_stone_window_thin.gltf | metallic-stone-risk | MI_Plaster uses metallic multiplier 1.00 with a metallic/roughness texture; inspect channel values | KEEP |
...
| MEDIUM | assets/models/architecture/bld_house_a.glb | many-materials | 9 materials | KEEP |
| MEDIUM | assets/models/characters/chr_player_base.glb | many-materials | 11 materials | IMPROVE |
| MEDIUM | assets/models/architecture/mod_roof_dormer.gltf | metallic-stone-risk | MI_Plaster uses metallic multiplier 1.00 with a metallic/roughness texture; inspect channel values | KEEP |
| MEDIUM | assets/models/characters/npc_innkeeper.glb | many-materials | 9 materials | KEEP |
| MEDIUM | assets/models/architecture/bld_blacksmith.glb | many-materials | 8 materials | KEEP |
| MEDIUM | assets/models/architecture/bld_inn.glb | many-materials | 7 materials | KEEP |
...
| MEDIUM | assets/models/architecture/mod_gable_8.gltf | metallic-stone-risk | MI_Plaster uses metallic multiplier 1.00 with a metallic/roughness texture; inspect channel values | KEEP |
...
| MEDIUM | assets/models/props/prp_bell_tower.glb | many-materials | 10 materials | KEEP |
...
| MEDIUM | assets/models/architecture/mod_stairs_exterior.gltf | metallic-stone-risk | MI_RockTrim uses metallic multiplier 1.00 with a metallic/roughness texture; inspect channel values | KEEP |
...
| INFO | assets/models/props/prp_timber_stack.glb | nonunit-import-scale | measured import correction is 4.88; do not normalize blindly | KEEP |
...
| INFO | assets/models/props/prp_fishing_hut.glb | nonunit-import-scale | measured import correction is 5.92; do not normalize blindly | KEEP |
...
| INFO | assets/models/props/prp_watch_tower.glb | nonunit-import-scale | measured import correction is 5.48; do not normalize blindly | KEEP |
...
| INFO | assets/models/props/prp_gate_palisade.glb | nonunit-import-scale | measured import correction is 8.2; do not normalize blindly | KEEP |
| INFO | assets/models/props/prp_mine_head.glb | nonunit-import-scale | measured import correction is 5.13; do not normalize blindly | KEEP |
| INFO | assets/models/props/prp_ore_seam.glb | nonunit-import-scale | measured import correction is 3.79; do not normalize blindly | KEEP |
| INFO | assets/models/props/prp_warden_post.glb | nonunit-import-scale | measured import correction is 3.74; do not normalize blindly | KEEP |
