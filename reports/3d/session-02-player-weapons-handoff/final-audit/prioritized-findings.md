...
| HIGH | assets/models/creatures/boss_iron_king.glb | collision-render-mismatch | Blender evaluated render height 1.25 m vs authored capsule height(s) [2.6] | IMPROVE |
...
| HIGH | assets/models/creatures/enm_ancient_dragon.glb | collision-render-mismatch | Blender evaluated render height 3.49 m vs authored capsule height(s) [5.0] | IMPROVE |
| HIGH | assets/models/creatures/enm_ancient_dragon.glb | ground-offset | lowest rendered point is Z=-0.543 m in Blender | IMPROVE |
...
| HIGH | assets/models/creatures/enm_ash_dragon.glb | ground-offset | lowest rendered point is Z=-4.223 m in Blender | IMPROVE |
...
| HIGH | assets/models/creatures/enm_bandit.glb | collision-render-mismatch | Blender evaluated render height 1.24 m vs authored capsule height(s) [1.8] | IMPROVE |
...
| HIGH | assets/models/creatures/enm_barrow_wight.glb | ground-offset | lowest rendered point is Z=-0.247 m in Blender | IMPROVE |
...
| HIGH | assets/models/creatures/enm_bone_knight.glb | collision-render-mismatch | Blender evaluated render height 1.13 m vs authored capsule height(s) [1.8] | IMPROVE |
| HIGH | assets/models/creatures/enm_bone_knight.glb | ground-offset | lowest rendered point is Z=-0.337 m in Blender | IMPROVE |
...
| HIGH | assets/models/creatures/enm_cinder_thrall.glb | collision-render-mismatch | Blender evaluated render height 1.01 m vs authored capsule height(s) [1.8] | IMPROVE |
...
| HIGH | assets/models/creatures/enm_clan_beast_tamer.glb | ground-offset | lowest rendered point is Z=-0.293 m in Blender | IMPROVE |
...
| HIGH | assets/models/creatures/enm_clan_raider.glb | ground-offset | lowest rendered point is Z=-0.309 m in Blender | IMPROVE |
...
| HIGH | assets/models/creatures/enm_frost_drake.glb | ground-offset | lowest rendered point is Z=-2.020 m in Blender | IMPROVE |
...
| HIGH | assets/models/creatures/enm_goblin.glb | collision-render-mismatch | Blender evaluated render height 0.58 m vs authored capsule height(s) [1.7] | IMPROVE |
| HIGH | assets/models/creatures/enm_goblin.glb | ground-offset | lowest rendered point is Z=0.595 m in Blender | IMPROVE |
...
| HIGH | assets/models/creatures/enm_grave_shade.glb | ground-offset | lowest rendered point is Z=-0.247 m in Blender | IMPROVE |
...
| HIGH | assets/models/creatures/enm_hollow_husk.glb | collision-render-mismatch | Blender evaluated render height 1.09 m vs authored capsule height(s) [1.75] | IMPROVE |
| HIGH | assets/models/creatures/enm_hollow_husk.glb | ground-offset | lowest rendered point is Z=-0.328 m in Blender | IMPROVE |
...
| HIGH | assets/models/creatures/enm_ruin_crawler.glb | ground-offset | lowest rendered point is Z=-0.417 m in Blender | IMPROVE |
...
| HIGH | assets/models/creatures/enm_stone_sentinel.glb | ground-offset | lowest rendered point is Z=-1.448 m in Blender | IMPROVE |
...
| HIGH | assets/models/creatures/enm_syndicate_enforcer.glb | collision-render-mismatch | Blender evaluated render height 1.21 m vs authored capsule height(s) [1.8] | IMPROVE |
...
| HIGH | assets/models/creatures/enm_ward_golem.glb | ground-offset | lowest rendered point is Z=-1.538 m in Blender | IMPROVE |
...
| HIGH | assets/models/creatures/enm_wild_dragon.glb | ground-offset | lowest rendered point is Z=-3.672 m in Blender | IMPROVE |
