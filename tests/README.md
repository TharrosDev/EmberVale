...
| --- | --- | --- | --- | --- |
| `--mode fast` | generated data, warning-free build, pure xUnit logic, region template, seams and layout | gate, every change | no | quality summary/logs |
| `--mode engine` | fast gates plus `--validate`, live map/step/collision/scene/streaming/new-game/traversal/melee regressions | gate, every change | headless | quality summary/logs |
