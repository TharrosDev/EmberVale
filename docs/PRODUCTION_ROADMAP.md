...
**Immediate next step: Phase 32D — party persistence round-trip.** Phase 31 (Audio Foundations) is
...
onto their stats, and exposed to dialogue as recruit/loyalty effects and conditions. Then 32D–32E and
33 (slice assembly) toward **Gate G1 — Vertical Slice**. (Phase 30.5 UI & HUD Overhaul complete.) Remaining audio *production* (real CC0 music/ambience
