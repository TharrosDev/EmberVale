...
| 38 | ⏳ | **Economy, vendors & services.** 38A–38S done, **38T next** (38G parked — see `docs/NOW.md`) — sub-phase detail in [Phase 38 — what shipped, sub-phase by sub-phase](#phase-38--what-shipped-sub-phase-by-sub-phase) below |
