...
| 38 | ⏳ | **Economy, vendors & services.** 38A–38T done **including 38G** (unparked at 38S; nothing is parked now), **38U next** — sub-phase detail in [Phase 38 — what shipped, sub-phase by sub-phase](#phase-38--what-shipped-sub-phase-by-sub-phase) below |
