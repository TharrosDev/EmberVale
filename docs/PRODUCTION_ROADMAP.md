...
| 38 | ⏳ | **Economy, vendors & services.** 38A–38U done **including 38G** (unparked at 38S; nothing is parked now), **38V next and it closes the phase** — sub-phase detail in [Phase 38 — what shipped, sub-phase by sub-phase](#phase-38--what-shipped-sub-phase-by-sub-phase) below (that list stops at 38O; **`docs/playbook/phase-38.md` is the current one**) |
